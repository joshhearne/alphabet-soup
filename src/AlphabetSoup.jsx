...
=======
const [privacyDismissed, setPrivacyDismissed] = usePersisted(“as_privacy_ok”, false);
>>>>>>> b70428a7202c95ec19926c59e87f37b119a15730
...
<style>{`*, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; } html, body, #root { height: 100%; background: ${p.bg}; transition: background 0.25s; } /* Responsive card grid — tighter on small screens */ .char-grid { padding: 24px; display: flex; flex-wrap: wrap; gap: 8px; } .char-card { display: flex; flex-direction: column; align-items: center; min-width: 76px; flex: 0 0 auto; padding: 10px 12px; gap: 4px; border-radius: 4px; } @media (max-width: 480px) { .char-grid { padding: 16px; gap: 6px; } .char-card { min-width: 62px; padding: 8px; } }`}</style>
